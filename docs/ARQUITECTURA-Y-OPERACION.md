...
- `api/progress.mjs`: receptor histórico de contadores agregados. El formulario V2.4 no envía telemetría de navegación.
...
- Implementación web de Apps Script: se mantiene el mismo identificador para no cambiar la variable de Vercel; antes de abrir V2.4 debe publicarse una versión que incluya `Code.gs` actualizado.
...
La suite cubre modelo, interfaz, API, receptor y contrato V2.4. Entre otros casos verifica:
