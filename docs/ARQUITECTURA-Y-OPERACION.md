...
- `api/progress.mjs`: receptor histórico de contadores agregados. El formulario V2.3 no envía telemetría de navegación.
...
- Implementación web de Apps Script: se mantiene el mismo identificador para no cambiar la variable de Vercel; la versión V2.3 publicada es `@9`.
...
La suite cubre modelo, interfaz, API, receptor y contrato V2.3. Entre otros casos verifica:
