...
La versión actual del receptor procesa el esquema `expert-validation/2.9` y mantiene compatibilidad de recepción con V2.1, V2.2, V2.3, V2.4, V2.5, V2.6, V2.7 y V2.8 para conservar los archivos históricos. Después de actualizar el instrumento hay que publicar también `Code.gs` antes de abrir la recogida de respuestas.
