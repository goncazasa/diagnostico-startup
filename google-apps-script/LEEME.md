...
La versión actual del receptor procesa el esquema `expert-validation/2.5` y mantiene compatibilidad de recepción con V2.1, V2.2, V2.3 y V2.4 para conservar los archivos históricos. Después de actualizar el instrumento hay que publicar también `Code.gs` antes de abrir la recogida de respuestas.
